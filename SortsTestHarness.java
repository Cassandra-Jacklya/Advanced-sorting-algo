...
class SortsTestHarness 
{
    ...
    private static void usage() 
    {
		...
		System.out.println("		   M - quicksort median of three");
		System.out.println("		   t - 3 way quicksort");
                ...
                for (int repeat = 0 ; repeat < REPEATS ; repeat++)
                {
                    ...
                    switch (arrayType)
                    {
                        ...
                        case 'n' : // Randomly re-order *part* of the array
                            ...
                            break;
						case 'R' : // Places random repeating values in the array
...
//                    long startTime = System.currentTimeMillis();
                    ...
                    switch (sortType)
                    {
						...
						case 'M' : Sorts.quickSortMedian(A); break;
						case 't' : Sorts.quickSort3way(A); break;
